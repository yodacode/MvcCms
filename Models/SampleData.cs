    ...
    public class SampleData : DropCreateDatabaseIfModelChanges<CmsEntities>
    {
        protected override void Seed(CmsEntities context)
        {
            ...
            new List<Post>
            {
                ...
                new Post { Title = "Ipsum Dolor", Tag = tags.Single(g => g.Name == "Graphisme"), Date = DateTime.Parse("1989-11-04"), Month = "11", Year = "1989", Author = "Justine", Content = "Has autem provincias, quas Orontes ambiens amnis imosque pedes Cassii montis illius celsi praetermeans funrato Tigrane regnis Armeniorum abstractas dicioni Romanae coniunxit.", Slug="has-autem-provincias", Online= true },
                ...
                new Post { Title = "Let There Be Webdesign", Tag = tags.Single(g => g.Name == "Webdesign"), Date = DateTime.Parse("2006-12-02"), Month = "08", Year = "2006", Author = "Berta", Content = "Has autem provincias, quas Orontes ambiens amnis imosque pedes Cassii montis illius celsi praetermeans funditur in Parthenium <strong>mare, Gnaeus Pompeius superato</strong> Tigrane regnis Armeniorum abstractas dicioni Romanillius celsi praetermeans funditur in Parthenium mare, Gnaeus Pompeius superato Tigrane regnis Armenae coniunxit.", Slug="lorem-ipsum", Online= true },
                new Post { Title = "Balls to the Wall", Tag = tags.Single(g => g.Name == "Webdesign"), Date = DateTime.Parse("2006-12-01"),Month = "12", Year = "2006", Author = "Adolf", Content = "Has autem provincias, quas Orontes ambiens amnis imosque pedes Cassii montis illius celsi praetermeans funditur in Parthenium mare, Gnaeus Pompeius superato Tigrane regnis Armeniorum abstractas dicioni Romanae coniunxit.", Slug="ipsum-dolorem", Online= true },
                new Post { Title = "Restless and Wild", Tag = tags.Single(g => g.Name == "Webdesign"), Date = DateTime.Parse("2003-11-06"),Month = "11", Year = "2003", Author = "Staline", Content = "Has autem provincias, quas Orontes ambiens amnis imosque pedes Cassii montis illius celsi praetermeans funditur in Parthenium mare, Gnaeus Pompeius superato Tigrane regnis Armeniorum abstractas dicioni Romanae coniunxit.", Slug="ipsum-dolorem-lolilol", Online= true },
                new Post { Title = "Va y James prend moi", Tag = tags.Single(g => g.Name == "CMS"), Date = DateTime.Parse("2012-11-05"), Month = "11", Year = "2012", Author = "Zizou", Content = "Has autem provincias, quas Orontes ambiens amnis imosque pedes Cassii montis illius celsi praetermeans funditur in Parthenium mare, Gnaeus Pompeius superato Tigrane regnis Armeniorum abillius celsi praetermeans funditur in Parthenium mare, Gnaeus Pompeius superato Tigrane regnis Armenstractas dicioni Romanae coniunxit.", Slug="Dolor-sapeze-dolorem", Online= true },
